...
$ID = $_POST['ID'];
    ...
    $comments[]=array('CommentID' => $row['CommentID'], 'Comment'=>$row['Comment'], 'Name'=>$row['Name']);
...
<?php if (isset($comments)): ?>
        <table border="1px">
            <tr><th>ID</th><th>Comments</th><th>Comment From</th><th>Option</th></tr>
            <?php foreach ($comments as $Comment): ?>
            <tr>
            <td><center><?php echo($Comment['CommentID']);?></center></td>
            <td><center><?php echo($Comment['Comment']);?></center></td>
            <td><center><?php echo($Comment['Name']);?></center></td>
            <td>
            <form action="" method="post">          
                <input type="hidden" name="ID" value="<?php echo($Comment['CommentID']);?>">
